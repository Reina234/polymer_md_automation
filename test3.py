...
neutralized_results = ion_adder.add_ions(input_gro = solvated_box_results['solvated_gro_file'], topology_file= solvated_box_results['topology_file'], output_dir = output_dir)
