...
from modules.shared.pdb_validation.base_pdb_validator import (
    BasePDBValidator,
)
from modules.shared.utils.calculation_utils import calculate_minimum_box_size
...
class GROMACSPDBValidator(BasePDBValidator):
    ...
    def _generate_box_dimensions(
        ...
        box_dimensions = calculate_minimum_box_size(
            atom_coordinates, padding=padding, output_units=LengthUnits.ANGSTROM
        )
