...
from modules.atomistic.workflows.solvated_neutralised_polymer.workflow_config_ion import (
    workflow2,
)
...
def run_polymer_solvation_workflow(
    ...
    neutralised_gro = GenIon().run(
        outputs.gro, outputs.tpr, initial_minim_files.top_path, sol_name, temp_dir
    )
